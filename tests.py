...
# print("Virus checking results (hopefully all True):")
# for virus in viruses:
#     bool = is_virus_v2(get_hex_compressed("testfiles/viruses/"+virus), viruses_dict, 200)
#     print(virus + ": ", bool)
# print("\n")

# print("Non-virus checking results (hopefully all False):")
# for not_virus in not_viruses:
#     bool = is_virus_v2(get_hex_compressed("testfiles/non_viruses/"+not_virus), viruses_dict, 200)
#     print(not_virus + ": ", bool)
# print("\n")
